import { Controller, Get, Query, Post, Body, Put, Delete, BadRequestException } from '@nestjs/common'
...
export class MenuController {
  ...
  async delete(@IdParam() id: number): Promise<void> {
    if (await this.menuService.checkRoleByMenuId(id)) throw new BadRequestException('该菜单存在关联角色，无法删除')
